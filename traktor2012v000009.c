...
void initPWM(void)
{
	...
	OCR1B  = PWMvalue;  // setter TOP,dvs bestemmer pulsbredden
    TCCR1A = 0xA2; //1010 0010=A2  1000 0010=82 Setter aktive kanaler osv.
